...
function App() {
  ...
  return (
<div
  className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-yellow-100 to-orange-300"
>
      {!started ? (
        <div className="text-center space-y-6">
          ...
          <p className="text-xl text-orange-700">
            Word een Circus Assistent en help Tembo!
          </p>
          <button
